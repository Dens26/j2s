 ...
 */
final class Version20250116140244 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE honor_game (id INT AUTO_INCREMENT NOT NULL, honor_id INT NOT NULL, game_id INT NOT NULL, year VARCHAR(4) NOT NULL, INDEX IDX_E439F6426A78A2E8 (honor_id), INDEX IDX_E439F642E48FD905 (game_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
